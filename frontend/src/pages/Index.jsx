        ...
        <div className="w-[350px] bg-[#323335] m-auto px-6 py-4 rounded-md relative">
          ...
          {type === "signin" && (
            <form>
              ...
              <div>
                <button className="px-3 py-2 rounded-md bg-purple-500 w-full outline-nome hover:bg-purple-600 text-white">
                  Sign in
                </button>
              </div>
              <div className="flex py-4 justify-between items-center px-3">
                <div className="w-[45%] h-[1px] bg-[#434449]"></div>
                <div className=" w-[6%] text-white pb-1 px-1 text-center">
                  or
                </div>
                <div className="w-[45%] h-[1px] bg-[#434449]"></div>
              </div>
