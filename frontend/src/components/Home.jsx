    ...
    <div className="pt-5">
      <div className="w-fll flex justify-center items-center h-[250px] bg-gradient-to-r from-[#4c76cf] to-[#552ab8] relative rounded-md overflow-hidden">
        <button
          ...
          className="px-4 py-2 text-[15px] overflow-hidden text-center bg-[#8b3dffad] text-white rounded-[3px] font-medium hover:bg-[#8b3dffad3] absolute top-3 right-3"
        >
          Custom Size
        </button>
        <div
        ...
        >
          ...
          bg-[#8b3dffad] text-white rounded-[3px] font-medium 
          hover:bg-[#8b3dffad3] w-full"
          >
            Create new design
          </button>
        </div>
      ...
      <div>
        <h2 className="text-xl py-66 font-semibold text-white">
          Your recent designs
        </h2>
        <div>
          <Carousel
          ...
          >
            {[1, 2, 3, 4, 5, 6, 7, 8].map((d, i) => (
              <div className="relative group w-full h-[160px] px-2" key={i}>
                ...
                <div
                  className="absolute hidden cursor-pointer top-1 right-2 text-red-500
                 p-2 transition-all duration-500 group-hover:block"
                >
                  <FaTrash />
                </div>
              </div>
